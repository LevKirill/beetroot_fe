var simplebox = (function () {
  var _1, _2, _3, _4, _5, _6, _7, _8, _9 = null, _a = false, _b, _c, _d, _e, _f, _10 = 1, _11 = 20, _12 = new Image,
    fx = {style: {}}, _13, _14, _15, _16 = /\.(jpg|gif|png|bmp|jpeg)(.*)?$/i, _17 = /[^\.]\.(swf)\s*$/i, _18, _19 = [],
    _1a = {
      padding: 10,
      margin: 20,
      width: 560,
  ...
  function _3a(_40) {
    var _41 = Math.round(_13.width + (_14.width - _13.width) * _40),
      ...
      top = Math.round(_13.top + (_14.top - _13.top) * _40), _43 = Math.round(_13.left + (_14.left - _13.left) * _40);
  ...
  function _35() {
    var _4a = _45(), to = {}, _4b = _e.margin, _4c = _e.autoScale, _4d = _e.padding * 2, _4e = (_e.margin + _11) * 2,
      _4f = (_e.margin + _11) * 2;
